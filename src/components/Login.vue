...
const handleGoogleAuth = async () => {
  ...
  try {
    ...
    // If auth/operation-not-allowed, warn them to enable Google provider in console
...
<template>
  <div class="d-flex flex-column align-items-center justify-content-center min-vh-100 px-5" style="background-color: #121212;">
      ...
      <div class="card p-8 p-md-10 text-white border-secondary hover-glow-subtle" style="background-color: #1b1b1b; max-width: 450px; width: 100%; border: 1px solid #282828; border-radius: 12px;">
          <h2 class="fw-bolder mb-2 text-center" style="font-size: 32px; letter-spacing: 1px; color: #d26527;">WELCOME BACK</h2>
          <p class="text-muted text-center mb-8">Sign in to access your appointment scheduler.</p>
          ...
          <div class="mt-8 text-center">
              ...
              <router-link to="/register" class="ms-2 fw-bold text-warning text-decoration-none toggle-link">Sign Up</router-link>
          </div>
      </div>
